    ...
    <footer className="border-t border-border/60 bg-background">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 grid gap-12 md:grid-cols-4">
        ...
        <div className="md:col-span-2">
          ...
          <p className="mt-5 text-sm leading-7 text-muted-foreground max-w-md">
            Afero is a modern web development studio focused on building
            scalable, responsive, and high-performing digital experiences
      ...
      <div className="border-t border-border/60">
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
          ...
          <span>
            © {new Date().getFullYear()} Afero. All rights reserved.
          </span>

          <span>
            Designed & developed by Afero.
          </span>
