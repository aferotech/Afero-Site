              ...
              <Tilt3D maxTilt={6} scale={1.02} className="h-full">
                <article className="group flex flex-col justify-between glass-card-3d p-6 rounded-3xl h-full preserve-3d">
                  <div>
                    ...
                    <div className="flex flex-col gap-2 mt-6 transform translate-z-10" style={{ transform: "translateZ(20px)" }}>
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-4 transform translate-z-2" style={{ transform: "translateZ(10px)" }}>
                ...
                <Tilt3D maxTilt={8} scale={1.03} className="h-full">
                  <div className="group h-full rounded-2xl glass-card-3d p-8 flex flex-col justify-between preserve-3d">
                    <div>
                      ...
                      <h3 className="font-serif text-2xl mb-3 transform translate-z-10" style={{ transform: "translateZ(15px)" }}>
                        {step.title}
                      </h3>
                      <p className="text-sm text-muted-foreground leading-relaxed transform translate-z-2" style={{ transform: "translateZ(8px)" }}>
                        {step.description}
                      </p>
                    </div>
                  </div>
...
<<<<<<< HEAD
                <Tilt3D maxTilt={6} scale={1.02} className="h-full">
                  <div className="rounded-2xl glass-card-3d p-8 h-full preserve-3d">
                    ...
                    <h3 className="font-serif text-xl mb-2 transform translate-z-10" style={{ transform: "translateZ(15px)" }}>
                      {card.title}
                    </h3>
                    <p className="text-sm text-muted-foreground leading-relaxed transform translate-z-2" style={{ transform: "translateZ(8px)" }}>
                      {card.description}
