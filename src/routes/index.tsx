            ...
            <article className="group glass-card-3d p-6 md:p-8 rounded-3xl">
              <div className="flex items-baseline justify-between mb-4">
                <div className="flex items-baseline gap-3">
                  <h3 className="font-serif text-2xl md:text-3xl text-foreground transform translate-z-10">Tomato. - A Grocery Web App</h3>
                </div>
              ...
              <div className="overflow-hidden rounded-2xl border border-border bg-secondary/50 transform translate-z-6">
                <img src={ad} alt="Tomato. - A Grocery Web App" width={1280} height={800} className="w-full h-auto group-hover:scale-[1.015] transition-transform duration-[1.2s] ease-out" />
              </div>
            </article>
          </Tilt3D>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <Tilt3D maxTilt={6} scale={1.02} className="w-full">
              <article className="group glass-card-3d p-6 rounded-3xl h-full flex flex-col justify-between">
                ...
                <div className="overflow-hidden rounded-xl border border-border bg-secondary/50 transform translate-z-6">
                  <img src={work2} alt="Praxis Studio website" width={1024} height={768} loading="lazy" className="w-full h-auto group-hover:scale-[1.015] transition-transform duration-[1.2s] ease-out" />
                </div>
              </article>
            </Tilt3D>
            ...
            <Tilt3D maxTilt={6} scale={1.02} className="w-full">
              <article className="group glass-card-3d p-6 rounded-3xl h-full flex flex-col justify-between">
                ...
                <div className="overflow-hidden rounded-xl border border-border bg-secondary/50 transform translate-z-6">
                  <img src={work3} alt="Meridian Daily website" width={1024} height={768} loading="lazy" className="w-full h-auto group-hover:scale-[1.015] transition-transform duration-[1.2s] ease-out" />
                </div>
              </article>
            </Tilt3D>
              ...
              <Tilt3D key={s.title} maxTilt={8} scale={1.03} className="h-full">
                <div className="group h-full rounded-2xl glass-card-3d p-8 flex flex-col justify-between preserve-3d">
                  <div>
                    ...
                    <h3 className="font-serif text-2xl transform translate-z-10" style={{ transform: "translateZ(20px)" }}>
                      {s.title}
                    </h3>
                    <p className="mt-3 text-sm text-muted-foreground leading-relaxed" style={{ transform: "translateZ(10px)" }}>
                      {s.body}
                    </p>
                  </div>
          ...
          {reasons.map((r) => (
            <Tilt3D key={r.n} maxTilt={6} scale={1.02}>
              <div className="rounded-2xl border border-border p-8 bg-card h-full glass-card-3d preserve-3d">
                <div className="font-serif text-coral text-4xl transform translate-z-10" style={{ transform: "translateZ(25px)" }}>
                  {r.n}
                </div>
                <h3 className="font-serif text-2xl mt-4 transform translate-z-6" style={{ transform: "translateZ(15px)" }}>
                  {r.title}
                </h3>
                <p className="mt-3 text-sm text-muted-foreground leading-relaxed transform translate-z-2" style={{ transform: "translateZ(8px)" }}>
                  {r.body}
                </p>
              </div>
            </Tilt3D>
            ...
            <div className="grid grid-cols-3 gap-6 rounded-2xl glass-card-3d p-8 md:p-10 backdrop-blur-md">
              {[
                ...
                <div key={s.l} className="preserve-3d">
                  <div className="font-serif text-4xl md:text-5xl text-coral transform translate-z-10" style={{ transform: "translateZ(20px)" }}>
                    {s.n}
                  </div>
                  <div className="mt-2 text-xs md:text-sm text-muted-foreground uppercase tracking-wider font-medium transform translate-z-2" style={{ transform: "translateZ(10px)" }}>
                    {s.l}
                  </div>
                </div>
              ))}
