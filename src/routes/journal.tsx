...
export const Route = createFileRoute("/journal")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Notes, essays, and field reports from the Afero studio on design, strategy, and the craft of making websites." },
...
const posts = [
  ...
  { title: "Designing for nonprofits without making it sad", date: "Feb 2026", read: "5 min", tag: "Design" },
  { title: "A small studio's pricing model, in full", date: "Jan 2026", read: "9 min", tag: "Studio" },
];
        ...
        {posts.map((p) => (
          ...
          >
            <div>
              ...
              <h3 className="font-serif text-2xl md:text-3xl group-hover:text-coral transition-colors">{p.title}</h3>
              <div className="text-xs text-muted-foreground mt-2">{p.date} · {p.read} read</div>
            </div>
