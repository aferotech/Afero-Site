          ...
          <Tilt3D maxTilt={4} scale={1.01} className="w-full">
            ...
            >
              <div className="transform translate-z-4" style={{ transform: "translateZ(10px)" }}>
                ...
                <input id="name" required className="mt-2 w-full bg-transparent border-b border-border/80 py-2 outline-none focus:border-coral transition duration-300 placeholder:text-muted-foreground/30" placeholder="Your name" />
              </div>
              <div className="transform translate-z-4" style={{ transform: "translateZ(10px)" }}>
                <label htmlFor="email" className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Email</label>
                <input id="email" required type="email" className="mt-2 w-full bg-transparent border-b border-border/80 py-2 outline-none focus:border-coral transition duration-300 placeholder:text-muted-foreground/30" placeholder="you@company.com" />
              </div>
              <div className="transform translate-z-4" style={{ transform: "translateZ(10px)" }}>
                <label htmlFor="company" className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">Company</label>
                <input id="company" className="mt-2 w-full bg-transparent border-b border-border/80 py-2 outline-none focus:border-coral transition duration-300 placeholder:text-muted-foreground/30" placeholder="Optional" />
              </div>
              <div className="transform translate-z-4" style={{ transform: "translateZ(10px)" }}>
                <label htmlFor="message" className="text-xs uppercase tracking-widest text-muted-foreground font-semibold">About the project</label>
                <textarea id="message" required rows={5} className="mt-2 w-full bg-transparent border-b border-border/80 py-2 outline-none focus:border-coral transition duration-300 resize-none placeholder:text-muted-foreground/30" placeholder="Goals, timeline, anything we should know…" />
              </div>
